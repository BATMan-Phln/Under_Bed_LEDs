...
void MomsPIRs()     //Probably connected to FOOT PIR also
  {
      ...
      Serial.println(" DN") ;   
      irsend.sendNEC(0xFFBA45, 32) ;      //Turn brightness down to minimum
      Serial.println(" DN") ;   
      irsend.sendNEC(0xFFBA45, 32) ;      //Do I need a delay between sending codes?
      Serial.println(" DN") ;   
      ...
      irsend.sendNEC(0xFFBA45, 32) ;
      Serial.println(" UP") ;    
      irsend.sendNEC(0xFF3AC5, 32) ;      //Turn brightness up to medium
      Serial.println(" UP") ;    
